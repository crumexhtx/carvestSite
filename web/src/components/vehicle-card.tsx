...
export function VehicleCard({
  ...
  return (
    <article className="carvana-card group relative overflow-hidden">
      ...
      <button
        ...
        className="absolute right-3 top-3 z-10 rounded-full bg-card/95 p-2 text-slate-600 shadow-sm transition hover:text-violet-600"
        onClick={(event) => {
